package com.wsw.gmall.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.wsw.gmall.utils.*;
...
public class JsonMocker {
    ...
    RanOpt[] eventOpts= {new RanOpt("addFavor",19),new RanOpt("addComment",15),
    ...
    String initStartupLog( ){
     ...
     `area` string COMMENT '城市' */
        ...
        String mid= "mid_"+ RandomNum.getRandInt(1,60);
